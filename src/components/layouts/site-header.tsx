...
export function SiteHeader({ user }: SiteHeaderProps) {
  return (
    <header className="bg-background sticky top-0 z-10 w-full border-b px-2 py-4 lg:px-4">
      <div className="container grid grid-cols-2 place-items-baseline gap-2 sm:grid-cols-3">
        <Link href={"/"} className="my-auto hidden text-center text-xs leading-3 lg:block">
